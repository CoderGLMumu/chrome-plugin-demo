...
$('#open_url_new_tab').click(() => {
  chrome.tabs.create({ url: 'https://vcp.jd.com/' });
});

// 当前标签打开网页
$('#open_url_current_tab').click(() => {
  getCurrentTabId(tabId => {
    chrome.tabs.update(tabId, { url: 'https://passport.jd.com/new/login.aspx?ReturnUrl=//vcp.jd.com&rs=vc' });
  });
});
